...
import 'package:ulastir/common/providers/lines_notifier.dart';
import 'package:ulastir/common/ui/widgets/custom_outlined_button.dart';
import 'package:ulastir/app/theme/designer.dart';
import 'package:ulastir/common/ui/dialogs/dialogs.dart';
import 'package:ulastir/common/ui/widgets/route_design_widget.dart';
...
class NameNotifier extends AutoDisposeNotifier<String> {
  @override
  String build() => '';
...
final nameProvider = NotifierProvider.autoDispose<NameNotifier, String>(
  NameNotifier.new,
);

final linesProvider = NotifierProvider<LinesNotifier, List<Line>>(
  LinesNotifier.new,
);
...
class _RouteDesignerPageState extends ConsumerState<RouteDesignerPage> {
  ...
  void askDeleteRoute(String routeID) {
    Dialogs.askDialog(
        context: context,
